...
// img
import e500 from '/assets/images/error/500.png'
import errorBg5 from '/assets/images/error/error-bg-4.png'
import errorBg2 from '/assets/images/error/error-bg-2.png'
import errorBg3 from '/assets/images/error/error-bg-3.png'
import errorBg6 from '/assets/images/error/error-bg-1.png'
            ...
            <div className="bg-primary-subtle vh-100 position-relative">
                <div className="container text-center">
                    <div className="row flex-column justify-content-center align-items-center vh-100">
                        <div>
                            <Image src={e500} className="img-fluid mb-4 w-50" alt="400" loading="lazy"/> 
                            <p className="mt-5 text-center text-body">The Page You Requested Could Not Be Found<br /> Please Go Back To Homepage</p>
