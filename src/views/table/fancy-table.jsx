                                                    ...
                                                    <tr key={index}>
                                                        <td>
                                                            <div className="d-flex align-items-center flex-wrap gap-2">
                                                                <Image className="rounded img-fluid avatar-65 me-3" src={item.img} alt="" />
                                                        ...
                                                        <td>
                                                            <span className={`badge rounded bg-${item.bgColor} p-2 text-${item.statusColor}`}>{item.status}</span>
                                                        </td>
                                                        <td>
                                                            <div className="flex align-items-center list-user-action">
                                                                <Link className="text-success pe-2" data-bs-toggle="tooltip" data-placement="top" title="" data-original-title="Add" href="#">
                                                                ...
                                                                <Link className="text-warning pe-2" data-bs-toggle="tooltip" data-placement="top" title="" data-original-title="Edit" href="#">
                                                                    <span className="btn-inner">
                                                                        <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                            <path d="M9.31055 14.3321H14.75" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path>
                                                                            ...
                                                                            <path d="M7.26562 3.50073L11.3548 6.64108" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path>
                                                                        </svg>
                                                                    </span>
                                                                </Link>{" "}
                                                                <Link className="text-danger" data-bs-toggle="tooltip" data-placement="top" title="" data-original-title="Delete" href="#">
                                                                    <span className="btn-inner">
                                                                        <svg width="15" height="16" viewBox="0 0 15 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                            ...
                                                                            <path d="M13.5312 3.67969H0.812744" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path>
