                    ...
                    <Card>
                        <Card.Body>
                            ...
                            <div className="d-flex justify-content-between align-items-center">
                                <h6 className="counter"><b>$<CountUp start={789} end={18378} duration={3} separator='' /></b></h6>
                        ...
                        <Card.Body>
                            ...
                            <div className="d-flex justify-content-between">
                                <div className="d-flex align-items-center">
                                    ...
                                    <h2 className="counter"><CountUp start={8} end={32} duration={3} />%</h2>
                                </div>
                                <div className="pt-3">
                            ...
                            <Card.Body>
                                ...
                                <div className="d-flex justify-content-between align-items-center mt-2">
                                    ...
                                    <div className="text-left">
                                        ...
                                        <div className="mb-3">1500<span className="text-danger">{" "}
                                        ...
                                        <p className="m-0 text-uppercase mt-3">1 Day Ago</p>
                                        <div className="mb-3">1890<span className="text-success">{" "}
                                            <svg className="icon-20" width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <p className="m-0 text-uppercase mt-3">1 Week Ago</p>
                                        <div>1260<span className="text-danger">{" "}
                                            <svg className="icon-20" width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M12.2744 19.75V4.75" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path>
                                                <path d="M18.299 13.7002L12.275 19.7502L6.25 13.7002" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path>
                                            </svg>{" "}
                        ...
                        <Card.Body>
                            <div className="d-flex justify-content-between align-items-center flex-wrap gap-2 mb-4">
                                <div>
                                    ...
                                    <p className="mb-0">carry out writing exam in school</p>
                                </div>
                                <div>
