    ...
    return (
        <Fragment>
            <Row>
                        ...
                        <CardBody>
                            <div className="d-flex justify-content-between align-items-center">
                                ...
                                <div className="text-end">
                                    <h2 className="counter"><CountUp start={565} end={5600} duration={3} separator="" /></h2>
                                    Doctors
                                </div>
                            </div>
                        </CardBody>
                    ...
                    <Card className="card bg-danger-subtle">
                        <CardBody>
                            <div className="d-flex justify-content-between align-items-center">
                                ...
                                <div className="text-end">
                                    <h2 className="counter"><CountUp start={565} end={3500} duration={3} separator="" /></h2>
                                    Patients
                                </div>
                            </div>
                        </CardBody>
                ...
                <Col lg="3" md="6">
                    <Card className="card bg-primary-subtle">
                        <CardBody>
                            <div className="d-flex justify-content-between align-items-center">
                                <div className="bg-primary-subtle rounded p-3">
                                    <svg className="icon-20" width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div className="text-end">
                                    <h2 className="counter"><CountUp start={565} end={4500} duration={3} separator="" /></h2>
                                    Pharmacists
                                </div>
                            </div>
                        </CardBody>
                    ...
                    <Card className="border-bottom border-4 border-0 border-danger">
                        <Card.Body>
                            <div className="d-flex justify-content-between align-items-center">
                                ...
                                <div>
                                    <span className="counter"><CountUp start={275} end={1200} duration={3} separator="" /></span>
                                </div>
                            </div>
                        </Card.Body>
                    </Card>
                    ...
                    <Card className="border-bottom border-4 border-0 border-warning">
                        <Card.Body>
                            <div className="d-flex justify-content-between align-items-center">
                                ...
                                <div>
                                    <span className="counter">$<CountUp start={10000} end={54000} duration={3} separator="" /></span>
                                </div>
                            </div>
                        </Card.Body>
                    </Card>
                ...
                <Col lg="4">
                    <Card>
                        <Card.Body>
                            <h2 className="counter mb-3">$<CountUp start={495} end={3450} duration={3} separator="" /></h2>
                            ...
                            <div className="mt-3">
                                <div className="pb-3">
                                    ...
                                    <div className="progress bg-info-subtle w-100" style={{ height: "10px" }}>
                                        <ProgressBar
                                            className={`bg-info shadow-none`}
                                            role="progressbar"
                                            style={{
                                ...
                                <div className="pb-3">
                                    ...
                                    <div className="progress bg-success-subtle w-100" style={{ height: "10px" }}>
                                        <ProgressBar
                                            className={`bg-success shadow-none`}
                                            role="progressbar"
                                            style={{
                                ...
                                <div className="pb-3">
                                    ...
                                    <div className="progress bg-primary-subtle w-100" style={{ height: "10px" }}>
                                        <ProgressBar
                                            className={`bg-primary shadow-none`}
                                            role="progressbar"
                                            style={{
                                ...
                                <Card.Body>
                                    <div className="d-flex justify-content-between">
                                        <div>
                                            ...
                                            <div className="mt-2">
                                                <h2 className="counter">$<CountUp start={12163} end={35000} duration={3} separator="" /></h2>
                                            </div>
                                        </div>
                                        <div>
                                ...
                                <Card.Body>
                                    <div className="d-flex justify-content-between">
                                        <div>
                                            ...
                                            <div className="mt-2">
                                                <h2 className="counter"><CountUp start={754} end={2500} duration={3} separator="" /></h2>
                                            </div>
                                        </div>
                                        <div>
                                    ...
                                    <div className="mt-3">
                                        <div className="progress bg-warning-subtle w-100" style={{ height: "6px" }}>
                                            <ProgressBar
                                                className={`bg-warning shadow-none`}
                                                role="progressbar"
                                                style={{
                                                    width: `${width7}%`,
                                                    transition: "width 0.2s ease",
                                ...
                                <Card.Body>
                                    <div className="d-flex justify-content-between">
                                        <div>
                                            <span><b>Leads</b></span>
                                            <div className="mt-2">
                                                <h2 className="counter">$<CountUp start={12000} end={35000} duration={3} separator="" /></h2>
                                            </div>
                                        </div>
                                        <div>
                    ...
                    <Card>
                        <Card.Body>
                            ...
                            <div className="d-flex justify-content-between mt-3">
                                <div>
                                    <h2 className="counter mb-0   "><CountUp start={784} end={4500} duration={3} separator="" /></h2>
                                    <div>Operations</div>
                                </div>
                                <div>
