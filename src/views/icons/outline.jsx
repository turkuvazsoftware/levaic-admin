...
const outline_icons = [
    ...
    },
    {
        id: '102',
        name: 'eye',
        svgIcon: `<svg xmlns="http://www.w3.org/2000/svg" class="icon-32" width="32" viewBox="0 0 24 24" fill="none">
    ...
    },
    {
        id: '106',
        name: 'Search-Add',
        svgIcon: `<svg width="32" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <Card className="mb-4">
                        ...
                        <Card.Body>
                            <div className="icon-grid">
                                ...
                                {outline_icons
                                    .filter((solid) => solid.name.toLowerCase().includes(searchdata.toLowerCase()))
                                    .map((icon) => (
                                        <div className="icon-box" key={icon.id}>
                                            <div className="overlay">
                                                ...
                                                >
                                                    <Button show='true' onClick={() => copyIcon(icon.svgIcon)} onMouseEnter={(e) => { e.stopPropagation(); }} onMouseLeave={(e) => { e.stopPropagation(); setTooltipText('Copy') }} variant="btn btn-sm btn-primary-subtle">
                                                        Copy
                                                    </Button>
                                                </OverlayTrigger>
                                            </div>
