...
const Tag = () => {
    ...
    const handleSaveTag = async () => {
        ...
        const response = await appAxios.post("/create_tag.php", params.toString());
    ...
    const handleDeleteTag = async (id) => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                const response = await appAxios.post("/delete_tag.php", params.toString());
    ...
    const handleUpdateTag = async () => {
        ...
        const response = await appAxios.post("/update_tag.php", params.toString());
    ...
    const currentTagItems = filteredTags.slice(startPage, startPage + itemsPerPage);
    return (
        <>
            <Row>
                <Col lg="12">
                            ...
                            <div className="card-header">
                                <Row className="align-items-center gy-3">
                                    ...
                                    <Col md="8" lg="6" className="text-md-end">
                                        <div className="">
                                            <Nav as="ul" id="tag-table-tab" role="tablist" className="nav nav-tabs d-inline-flex align-items-center gap-3 flex-wrap mb-0 px-0">
                                                <li>
                                                    <Button variant="primary" onClick={handleShow}>
                                                        <span className="btn-inner">
                                                            <span className="text d-inline-block align-middle">Etiket Ekle</span>{" "}
                            ...
                            <Card.Body className="pt-0">
                                ...
                                <div className="table-responsive">
                                    <Table className="table border-end border-start align-middle rounded">
                                        ...
                                        <tbody>
                                            {currentTagItems.map((item, index) => (
                                                <tr data-item="list" key={index}>
                                                    ...
                                                    <td>
                                                        ...
                                                        <Link to="#" className="d-inline-block ps-2 delete-btn" onClick={() => handleDeleteTag(item.id)}>
                                ...
                                <Pagination
                                    ...
                                    onPageChange={(page) => {
                                        if (page >= 1 && page <= Math.ceil(filteredTags.length / itemsPerPage)) {
                                            setCurrentPage(page);
                                        }
                                    }}
                                />
            ...
            >
                <Modal.Header closeButton>
                    <Modal.Title>Tag Ekle</Modal.Title>
                </Modal.Header>
                <Modal.Body>
                ...
                <Modal.Footer>
                    <div className="offcanvas-footer">
                        <div className="d-grid d-md-flex gap-3 p-3">
                            <Button type="submit" className="btn btn-primary d-block" onClick={handleSaveTag}>
                                <span className="btn-inner">
            ...
            >
                <Modal.Header closeButton>
                    <Modal.Title>Tag Güncelle</Modal.Title>
                </Modal.Header>
                <Modal.Body>
                    <div className="form-group col-md-12">
                        <Form.Group className="mb-3">
                ...
                <Modal.Footer>
                    <div className="offcanvas-footer">
                        <div className="d-grid d-md-flex gap-3 p-3">
                            <Button type="submit" className="btn btn-primary d-block" onClick={handleUpdateTag}>
                                <span className="btn-inner">
