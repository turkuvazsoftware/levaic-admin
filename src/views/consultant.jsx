...
const Consultant = () => {
    ...
    const filteredConsultants = consultantList.filter((consultant) =>
    ...
    const handleSaveConsultant = async () => {
        ...
        if (response.data.success) {
            toast.success("Danışman başarıyla eklendi!");
            fetchConsultants();
            handleClose();
    ...
    const currentConsultantItems = filteredConsultants.slice(startPage, startPage + itemsPerPage);
    return (
        <>
            <Row>
                <Col lg="12">
                                                    ...
                                                    <li>
                                                        <Button variant="primary" onClick={handleShow}>
                                                            <span className="btn-inner">
                                                                <span className="text d-inline-block align-middle">Danışman Ekle</span>{" "}
                            ...
                            <Card.Body className="pt-0">
                                ...
                                <div className="table-responsive">
                                    <Table className="table border-end border-start align-middle rounded">
                                        ...
                                        <tbody>
                                            {currentConsultantItems.map((item, index) => (
                                                    ...
                                                    <td>
                                                        {userRole === "admin" && (
                                                            <>
                                                                ...
                                                                <Link to="#" className="d-inline-block ps-2 delete-btn" onClick={() => handleDeleteConsultant(item.id)}>
                                ...
                                <Pagination
                                    ...
                                    onPageChange={(page) => {
                                        if (page >= 1 && page <= Math.ceil(filteredConsultants.length / itemsPerPage)) {
                                            setCurrentPage(page);
                                        }
                                    }}
                                />
            ...
            >
                <Modal.Header closeButton>
                    <Modal.Title>Danışman Ekle</Modal.Title>
                </Modal.Header>
                <Modal.Body>
                ...
                <Modal.Footer>
                    <div className="offcanvas-footer">
                        <div className="d-grid d-md-flex gap-3 p-3">
                            <Button type="submit" className="btn btn-primary d-block" onClick={handleSaveConsultant}>
                                <span className="btn-inner">
            ...
            >
                <Modal.Header closeButton>
                    <Modal.Title>Danışman Güncelle</Modal.Title>
                </Modal.Header>
                <Modal.Body>
                    <div className="form-group col-md-12">
                        <Form.Group className="mb-3">
                ...
                <Modal.Footer>
                    <div className="offcanvas-footer">
                        <div className="d-grid d-md-flex gap-3 p-3">
                            <Button type="submit" className="btn btn-primary d-block" onClick={handleUpdateConsultant}>
                                <span className="btn-inner">
