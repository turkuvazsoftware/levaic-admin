...
// React-boostrap
import {Row, Col, Nav, Tab, Button, InputGroup, Form} from 'react-bootstrap'
                    ...
                    <Card>
                        <Card.Body>
                            ...
                            <div className="d-flex align-items-center mt-2">
                                <Button bsPrefix=" d-flex" href="https://templates.iqonic.design/hope-ui/pro/documentation/react/datepicker" target="_blank">
                                    ...
                                    <Col md="6" className="order-md-1">
                                        <div className="bd-example">
                                            <div className="form-group">
                                                <Flatpickr options={{ minDate: "today"}} className="form-control flatpickrdate" placeholder="Date Picker" />
                                            </div>
                                        </div>
                                        <div className="bd-example">
                                            <div className="form-group">
