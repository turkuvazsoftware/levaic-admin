                    ...
                    <Card>
                        <Card.Body>
                            ...
                            <div className="d-flex align-items-center mt-2">
                                <Button bsPrefix=" d-flex" href="https://templates.iqonic.design/hope-ui/pro/documentation/react/floating-lable" target="_blank">
                ...
                <Card className=" iq-document-card">
                    <Tab.Container  defaultActiveKey="first">
                        <div className="d-flex justify-content-end">
                            <Nav as="ul" className=" nav-tabs nav-tunnel nav-slider" data-toggle="slider-tab" role="tablist">
                                <Nav.Item as="li" className="" role="presentation">
                                    <Nav.Link as="button" eventKey="first" className="d-flex align-items-center" data-bs-toggle="tab" data-bs-target="#content-floating-prv" type="button" role="tab" aria-controls="output" aria-selected="true">
                                        <svg width="20" className="me-1" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <Nav.Item as="li" role="presentation">
                                    <Nav.Link as="button" eventKey="second" className=" d-flex align-items-center" data-bs-toggle="tab" data-bs-target="#content-floating-code" type="button" role="tab" aria-controls="profile" aria-selected="false">
                                        <svg width="20" className="me-1" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <Tab.Content className='mt-2'>
                            <Tab.Pane eventKey="first" className=" bd-heading-1 fade show " id="content-floating-prv" role="tabpanel" aria-labelledby="typo-output">
                                <div className="bd-example">
                                    <Form>
                                        ...
                                        <Form.Floating className="form-floating form-group mb-3">
                                            <Form.Control type="email" className="is-valid" id="floatingInput3" autoComplete="username email" 
                            ...
                            <Tab.Pane eventKey="second" className="e bd-heading-1 fade show" id="content-floating-code" role="tabpanel" aria-labelledby="typo-output">
