            ...
            <article id="dropdowns">
                    ...
                    <Card>
                        <Card.Body>
                            ...
                            <div className="d-flex align-items-center mt-2">
                                <Button bsPrefix=" d-flex" href="https://templates.iqonic.design/hope-ui/pro/documentation/react/dropdowns" target="_blank">
                ...
                <Card className=" iq-document-card">
                    <Tab.Container defaultActiveKey="first">
                        <div className="d-flex justify-content-end">
                            <Nav as="ul" className=" nav-tabs nav-tunnel nav-slider" data-toggle="slider-tab" role="tablist">
                                <Nav.Item as="li" className="" role="presentation">
                                    <Nav.Link eventKey="first" as="button" className=" d-flex align-items-center" data-bs-toggle="tab" data-bs-target="#content-dropdown-prv" type="button" role="tab" aria-controls="output" aria-selected="true">
                                        <svg width="20" className="me-1" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <Nav.Item as="li" role="presentation">
                                    <Nav.Link as="button" eventKey="second" className=" d-flex align-items-center" data-bs-toggle="tab" data-bs-target="#content-dropdown-code" type="button" role="tab" aria-controls="profile" aria-selected="false">
                                        <svg width="20" className="me-1" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <Tab.Content>
                            <Tab.Pane eventKey="first" className=" bd-heading-1 fade show " id="content-dropdown-prv" role="tabpanel" aria-labelledby="typo-output">
                                <div className="bd-example">
                                    <div className="btn-group w-100 align-items-center flex-wrap mt-0 custom-rtl-dropdown">
                                ...
                                <div className="bd-example">
                                    <Dropdown as={ButtonGroup} className=" w-100 align-items-center flex-wrap mt-0 custom-rtl-dropdown">
                                        <Dropdown drop={'end'} >
                                            <Dropdown.Toggle className="me-2" as={Button} variant="gray" type="button" id="dropendMenuButton" >
                                                Dropend button
                                            </Dropdown.Toggle>
                                            <Dropdown.Menu >
                                                <li><h6 className="dropdown-header">Dropdown header</h6></li>
                                        ...
                                        <Dropdown drop={'down'} className='ms-0 ms-sm-2'>
                            ...
                            <Tab.Pane eventKey="second" className=" bd-heading-1 fade show" id="content-dropdown-code" role="tabpanel" aria-labelledby="typo-output">
