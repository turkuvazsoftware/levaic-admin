                    ...
                    <Card>
                        <Card.Body>
                            ...
                            <div className="d-flex align-items-center mt-2">
                                <Button bsPrefix=" d-flex" href="https://templates.iqonic.design/hope-ui/pro/documentation/react/navsandtabs" target="_blank">
                        ...
                        <div className="d-flex justify-content-end">
                            <Nav as="ul" className=" nav-tabs nav-tunnel nav-slider" data-toggle="slider-tab" role="tablist">
                                <Nav.Item as="li" role="presentation">
                                    <Nav.Link as="button" eventKey="first" className=" d-flex align-items-center" data-bs-toggle="tab" data-bs-target="#content-Navs-prv" type="button" role="tab" aria-controls="output" aria-selected="true">
                                        <svg width="20" className="me-1" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <Nav.Item as="li" role="presentation">
                                    <Nav.Link as="button" eventKey="second" className=" d-flex align-items-center" data-bs-toggle="tab" data-bs-target="#content-Navs-code" type="button" role="tab" aria-controls="profile" aria-selected="false">
                                        <svg width="20" className="me-1" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <Tab.Content>
                                <Tab.Pane eventKey="first" className=" bd-heading-1 fade show " id="content-Navs-prv" role="tabpanel" aria-labelledby="typo-output">
                                    ...
                                    <div className="bd-example">
                                        <Tab.Container defaultActiveKey="first">   
                                            <nav className="tab-bottom-bordered mb-3">
                                                <Nav variant="tabs" className="mb-0" id="nav-tab" role="tablist" >
                                                    <Nav.Link eventKey="first" variant=" d-flex align-items-center" id="nav-home-tab" data-bs-toggle="tab" data-bs-target="#nav-home" type="button" role="tab" aria-controls="nav-home" aria-selected="true">Home</Nav.Link>
                                                    <Nav.Link eventKey="second" variant="" id="nav-profile-tab" data-bs-toggle="tab" data-bs-target="#nav-profile" type="button" role="tab" aria-controls="nav-profile" aria-selected="false">Profile</Nav.Link>
                                                    <Nav.Link eventKey="third" variant="" id="nav-contact-tab" data-bs-toggle="tab" data-bs-target="#nav-contact" type="button" role="tab" aria-controls="nav-contact" aria-selected="false">Contact</Nav.Link>
                                                </Nav>
                                    ...
                                    <div className="bd-example">
                                        <Tab.Container defaultActiveKey="first"> 
                                            <Nav variant="tabs nav-tunnel nav-slider" data-toggle="slider-tab" role="tablist">
                                                <Nav.Item  role="presentation">
                                                    <Nav.Link eventKey="first"  className=" d-flex align-items-center" data-bs-toggle="tab" data-bs-target="#pills-home1" type="button" role="tab" aria-controls="home" aria-selected="true">
                                                ...
                                                <Nav.Item  role="presentation">
                                                    <Nav.Link eventKey="second"  className=" d-flex align-items-center" data-bs-toggle="tab" data-bs-target="#pills-profile1" type="button" role="tab" aria-controls="profile" aria-selected="false">
                                                        <svg width="20" className="me-2" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <div className="bd-example">
                                        <Tab.Container defaultActiveKey="first">
                                            <Nav className="mb-3 nav-tabs nav-iconly gap-3"  role="tablist">
                                                <Nav.Link as='button' eventKey="first" data-bs-toggle="tab" data-bs-target="#pro-nav-home" type="button" role="tab" aria-controls="pro-nav-home" aria-selected="true">
                                                ...
                                                <Nav.Link as='button' eventKey="second" data-bs-toggle="tab" data-bs-target="#pro-nav-profile" type="button" role="tab" aria-controls="pro-nav-profile" aria-selected="false">
                                                ...
                                                <Nav.Link as='button' eventKey="third" data-bs-toggle="tab" data-bs-target="#pro-nav-contact" type="button" role="tab" aria-controls="pro-nav-contact" aria-selected="false">
                                                    <svg className="icon-40" width="40" viewBox="0 0 40 40" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <Nav.Link as='button' eventKey="four" data-bs-toggle="tab" data-bs-target="#pro-nav-demo" type="button" role="tab" aria-controls="pro-nav-contact" aria-selected="false">
                                                    <svg className="icon-40" width="40" viewBox="0 0 40 40" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <Tab.Pane eventKey="second" className="bd-heading-1 fade show" id="content-Navs-code" role="tabpanel" aria-labelledby="typo-output">
