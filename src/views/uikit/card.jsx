                    ...
                    <Card>
                        <Card.Body>
                            ...
                            <div className="d-flex align-items-center mt-2">
                                <Button bsPrefix=" d-flex" href="https://templates.iqonic.design/hope-ui/pro/documentation/react/cards" target="_blank">
                            ...
                            <Tab.Pane eventKey="first" className=" bd-heading-1 fade show " id="content-card-prv" role="tabpanel" aria-labelledby="typo-output">
                                <div className="bd-example">
                                    <Row className="row-cols-1 row-cols-md-2 g-4">
                                        <Col> 
                                            <Card className="mb-0">
                                                <svg className="bd-placeholder-img card-img-top" width="100%" height="180" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: Image cap" preserveAspectRatio="xMidYMid slice" focusable="false"><title>Placeholder</title><rect width="100%" height="100%" fill="#868e96"></rect><text x="50%" y="50%" fill="#dee2e6" dy=".3em" textAnchor='middle'>Image cap</text></svg>
                                                <Card.Body>
                                        ...
                                        <Col>
                                            ...
                                            <Row className="g-0">
                                                <Col md="4">
                                                <svg className="bd-placeholder-img rounded-start" width="100%" height="300" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: Image" preserveAspectRatio="xMidYMid slice" focusable="false"><title>Placeholder</title><rect width="100%" height="100%" fill="#868e96"></rect><text x="50%" y="50%" fill="#dee2e6" dy=".3em" textAnchor='middle'>Image</text></svg>
                                                </Col>
                                                <Col md="8">
                                                <Card.Body>
                                                    <h5 className="card-title">Card title</h5>
...
{`<div className="bd-example">
    <Row className="row-cols-1 row-cols-md-2 g-4">
        <Col> 
            <Card className="mb-0">
                <svg className="bd-placeholder-img card-img-top" width="100%" height="180" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: Image cap" preserveAspectRatio="xMidYMid slice" focusable="false"><title>Placeholder</title><rect width="100%" height="100%" fill="#868e96"></rect><text x="50%" y="50%" fill="#dee2e6" dy=".3em" text-anchor="middle">Image cap</text></svg>
                <Card.Body>
                    <h5 className="card-title">Card title</h5>
                    <p className="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                    <Link to="/" className="btn btn-primary">Go somewhere</Link>
        ...
        <Col>
            ...
            <Row className="g-0">
                <Col md="4">
                <svg className="bd-placeholder-img rounded-start" width="100%" height="250" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: Image" preserveAspectRatio="xMidYMid slice" focusable="false"><title>Placeholder</title><rect width="100%" height="100%" fill="#868e96"></rect><text x="30%" y="50%" fill="#dee2e6" dy=".3em">Image</text></svg>
                </Col>
                <Col md="8">
                <Card.Body>
                    <h5 className="card-title">Card title</h5>
