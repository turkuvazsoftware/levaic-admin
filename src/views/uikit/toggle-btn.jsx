                            ...
                            <Tab.Pane eventKey="first" className=" bd-heading-1 fade show " id="content-toggle-prv" role="tabpanel" aria-labelledby="typo-output">
                                <div className="bd-example">
                                    <Form.Check className=" form-check-inline">
                                        <FormCheck.Input type="checkbox" id="customCheck5"/>
                                        <FormCheck.Label className="pl-2" htmlFor="customCheck5">Checkbox</FormCheck.Label>
                                    </Form.Check>{' '}
                                    <Form.Check className=" form-check-inline">
                                        <FormCheck.Input type="checkbox" id="customCheck6" defaultChecked/>
                                        <FormCheck.Label className="pl-2" htmlFor="customCheck6">Checked</FormCheck.Label>
                                    </Form.Check>{' '}
                                    <Form.Check className=" form-check-inline">
                                ...
                                <div className="bd-example">
                                    ...
                                    <Form.Check className="form-switch form-check-inline">
                                        <FormCheck.Input type="checkbox" id="switch3" disabled />
                                        <FormCheck.Label className=" pl-2" htmlFor="switch3">Disabled Switch</FormCheck.Label>
                                    </Form.Check>{' '}
                                    <Form.Check className="form-switch form-check-inline">
                                        <FormCheck.Input className="form-check-inline" type="checkbox" id="switch4" defaultChecked disabled />
