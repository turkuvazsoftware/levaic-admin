                    ...
                    <Card>
                        <Card.Body>
                            ...
                            <div className="d-flex align-items-center mt-2">
                                <Button bsPrefix=" d-flex" href="https://templates.iqonic.design/hope-ui/pro/documentation/react/alert" target="_blank">
                            ...
                            <Tab.Pane eventKey="first" className=" bd-heading-1 fade show " id="content-alert-prv" role="tabpanel" aria-labelledby="typo-output">
                                ...
                                <div className="bd-example">
                                    ...
                                    <Alert variant="primary d-flex align-items-center" role="alert">
                                        <svg className="flex-shrink-0 bi me-2" width="24" height="24">
                                            <use href="#info-fill" />
                                        </svg>
                                        <div>
                                ...
                                <div className="bd-example">
                                    <Alert variant="success alert-left alert-dismissible fade show mb-3" role="alert" show={showA2} onClose={() => setshowA2(false)} dismissible>
                                        <span> This is a success alert—check it out!</span>
                                    </Alert>
                                    <Alert variant="info alert-top alert-dismissible fade show mb-3" role="alert" show={showA3} onClose={() => setshowA3(false)} dismissible>
                                        <span> This is a info alert—check it out!</span>
                                    </Alert>
                                    <Alert variant="warning alert-right alert-dismissible fade show mb-3" role="alert" show={showA4} onClose={() => setshowA4(false)} dismissible>
                                        <span> This is a warning alert—check it out!</span>
                                    </Alert>
                                    <Alert variant="danger alert-bottom alert-dismissible fade show" role="alert" show={showA5} onClose={() => setshowA5(false)} dismissible>
                                        <span> This is a danger alert—check it out!</span>
                                    </Alert>
                                </div>
                                <div className="bd-example">
                                    <Alert variant="warning rounded-0 alert-dismissible fade show " role="alert" show={showA6} onClose={() => setshowA6(false)} dismissible>
                                        <span> This is a warning alert—check it out!</span>
                                    </Alert>
                                </div>
                                <div className="bd-example">
...
<div className="bd-example">
    ...
    <Alert variant="info lert-top alert-dismissible fade show mb-3" role="alert" show={showA3} onClose={() => setshowA3(false)} dismissible>
        <span> This is a info alert—check it out!</span>
    </Alert>
    <Alert variant="warning right alert-dismissible fade show mb-3" role="alert" show={showA4} onClose={() => setshowA4(false)} dismissible>
        <span> This is a warning alert—check it out!</span>
    </Alert>
    <Alert variant="danger bottom alert-dismissible fade show" role="alert" show={showA5} onClose={() => setshowA5(false)} dismissible>
        <span> This is a danger alert—check it out!</span>
    </Alert>
</div>
<div className="bd-example">
