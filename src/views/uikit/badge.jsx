            ...
            <article id="badge">
                    ...
                    <Card>
                        <Card.Body>
                            ...
                            <div className="d-flex align-items-center mt-2">
                                <Button bsPrefix=" d-flex" href="https://templates.iqonic.design/hope-ui/pro/documentation/react/badge" target="_blank">
                ...
                <Card className="iq-document-card">
                    <Tab.Container defaultActiveKey="first">
                        <div className="d-flex justify-content-end">
                            <Nav as="ul" className=" nav-tabs nav-tunnel nav-slider" data-toggle="slider-tab" role="tablist">
                                <Nav.Item as="li" className="" role="presentation">
                                    <Nav.Link eventKey="first" as="button" className="  d-flex align-items-center" data-bs-toggle="tab" data-bs-target="#content-badge-prv" type="button" role="tab" aria-controls="output" aria-selected="true">
                                        <svg width="20" className="me-1" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <Nav.Item as="li" className="" role="presentation">
                                    <Nav.Link  eventKey="second" as="button" className=" d-flex align-items-center" data-bs-toggle="tab" data-bs-target="#content-badge-code" type="button" role="tab" aria-controls="profile" aria-selected="false">
                                        <svg width="20" className="me-1" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <Tab.Content>
                        <Tab.Pane eventKey="first" className="bd-heading-1 fade show " id="content-badge-prv" role="tabpanel" aria-labelledby="typo-output">
                            ...
                            <div className="bd-example">
                                <Row>
                                    ...
                                    <Col sm="3" className='mt-sm-0 mt-2'>
                            ...
                            <div className="bd-example">
                                <Badge pill bg="primary-subtle">Primary</Badge>{' '}
                                <Badge pill bg="secondary-subtle">Secondary</Badge>{' '}
                                <Badge pill bg="success-subtle">Success</Badge>{' '}
                                <Badge pill bg="danger-subtle">Danger</Badge>{' '}
                                <Badge pill bg="warning-subtle">Warning</Badge>{' '}
                                <Badge pill bg="info-subtle">Info</Badge>{' '}
                                <Badge pill bg="light-subtle text-dark">Light</Badge>{' '}
                                <Badge pill bg="dark-subtle text-dark">Dark</Badge>{' '}
                                <Badge pill bg="gray-subtle">Gray</Badge>
                            </div>
                            <div className="bd-example">
                        ...
                        <Tab.Pane eventKey="second" className=" bd-heading-1 fade show" id="content-badge-code" role="tabpanel" aria-labelledby="typo-output">
