                    ...
                    <Card>
                        <Card.Body>
                            ...
                            <div className="d-flex align-items-center mt-2">
                                <Button bsPrefix=" d-flex" href="https://templates.iqonic.design/hope-ui/pro/documentation/react/navbar" target="_blank">
                            ...
                            <Tab.Content className="mt-2">
                                <Tab.Pane eventKey="first" className=" bd-heading-1 fade show " id="content-Navbar-prv" role="tabpanel" aria-labelledby="typo-output">
                                    <div className="bd-example">
                                        ...
                                        <Navbar className="navbar-dark rounded-1 mt-4" expand="lg" bg="primary">
                                            <Container fluid>
                                        ...
                                        <Navbar className="navbar-dark rounded-1 mt-4" expand="lg" bg="danger">
                                            <Container fluid>
