...
// React-boostrap
import { Row, Col, Nav, Tab, Button, Collapse, CardBody } from 'react-bootstrap'

// components
// components
import Card from '../../components/bootstrap/card'

const UiCollapse = memo(() => {
                    ...
                    <Card>
                        <Card.Body>
                            ...
                            <div className="d-flex align-items-center mt-2">
                                <Button bsPrefix=" d-flex" href="https://templates.iqonic.design/hope-ui/pro/documentation/react/carousel" target="_blank">
                ...
                <Card className=" iq-document-card">
                    <Tab.Container defaultActiveKey="first">
                        <div className="d-flex justify-content-end">
                            <Nav as="ul" className=" nav-tabs nav-tunnel nav-slider" data-toggle="slider-tab" role="tablist">
                                <Nav.Item as="li" className="" role="presentation">
                                    <Nav.Link as="button" eventKey="first" className=" d-flex align-items-center" data-bs-toggle="tab" data-bs-target="#content-card-prv" type="button" role="tab" aria-controls="output" aria-selected="true">
                                        <svg width="20" className="me-1" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <Nav.Item as="li" className="" role="presentation">
                                    <Nav.Link as="button" eventKey="second" className=" d-flex align-items-center" data-bs-toggle="tab" data-bs-target="#content-card-code" type="button" role="tab" aria-controls="profile" aria-selected="false">
                                        <svg width="20" className="me-1" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <Tab.Content className="">
                            <Tab.Pane eventKey="first" className=" bd-heading-1 fade show " id="content-card-prv" role="tabpanel" aria-labelledby="typo-output">
                                <div className="bd-example">
                                    <p>
                                        <Link href="" className="btn btn-primary mt-2" onClick={() => setOpen5(!open5)} aria-controls="collapseExample"
                                            aria-expanded={open5} >Link with href </Link>
                                        {' '}
                                        <Button variant="btn btn-primary mt-2 " onClick={() => setOpen4(!open4)} aria-controls="example-collapse-text"
                                            aria-expanded={open4} >Button with data-bs-target</Button>
                                        {' '}
                                        <Button variant="btn btn-primary mt-2 " onClick={() => setOpen6(!open6)} aria-controls="example-collapse-text"
                                            aria-expanded={open6} >Toggle width collapse</Button>
                                    </p>
                                    <div>
                                        <Collapse in={open5}>
                                    ...
                                    <p>
                                        <Link href="" className="btn btn-primary mt-2" onClick={() => setOpen7(!open7)} aria-controls="collapseExample"
                                            aria-expanded={open7} >Toggle first element</Link>
                                        {' '}
                                        <Button variant="btn btn-primary mt-2 " onClick={() => setOpen8(!open8)} aria-controls="example-collapse-text"
                                            aria-expanded={open8} >Toggle second element</Button>
                                        {' '}
                                        <Button variant="btn btn-primary mt-2 " onClick={() => setOpen9(!open9)} aria-controls="example-collapse-text"
                                            aria-expanded={open9} >Toggle both elements</Button>
                                    </p>
                                    <div>
                                        <Collapse in={open7}>
                                            <div className="card card-body">
                                        ...
                                        <Row>
                                            <Col>
                                                <Collapse in={open9} className="collapse multi-collapse">
                                                    <div id="example-collapse-text">
                                                        <div className="card card-body">
                                                            Some placeholder content for the first collapse component of this
                                                            multi-collapse example. This panel is hidden by default but revealed
                            ...
                            <Tab.Pane eventKey="second" className=" bd-heading-1 fade show" id="content-card-code" role="tabpanel" aria-labelledby="typo-output">
...
<div className='d-flex gap-2'>
    ...
    <Button variant="btn btn-primary mt-2 " onClick={() => setOpen6(!open6)} aria-controls="example-collapse-text"
        aria-expanded={open6} >Button with data-bs-target</Button>
</div>
<div>
    <Collapse in={open5}>
        <div id="example-collapse-text">
