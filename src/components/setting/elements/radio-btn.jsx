...
const RadioBtn = memo((props) => {
    ...
    return (
        <div className={`${props.className}`}   >
            <input type="radio" defaultValue={props.value} className="btn-check" name={props.btnName} id={props.id}  autoComplete="off" defaultChecked={radioCheckValue(props.defaultChecked, props.value)} onClick={() => dispatch(SettingAction[props.btnName](props.value))} />
