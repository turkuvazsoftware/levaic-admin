...
const CheckboxBtn = memo((props) => {
    ...
    return (
        <div className={`${props.className}`}>
            <input type="checkbox" defaultValue={props.value} className={props.type === 'switch' ? 'form-check-input' : 'btn-check'} name={props.btnName} id={props.id} autoComplete="off" defaultChecked={checkboxCheckValue(props.defaultChecked, props.value)} onClick={changeDispatch} />
